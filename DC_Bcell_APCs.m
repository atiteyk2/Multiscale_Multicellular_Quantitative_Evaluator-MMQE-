...
function dydt = DC_Bcell_APCs(~,y,r)
...
sigma_2 = 1;          % Standard deviation  (m)
mu_4 = log(7080);
sigma_4 = 1;
...
for i = 1:N
    ...
    dydt(5) =  Rate_prod*y(6) + Gs*y(5)*y(4)/(y(4) + s_IL4b)- Mu_death*y(5); % EQUATION (8)
    dydt(6) = r(6)*AntiG(i) - AntiG_die*y(6);  % EQUATION (9)
    
    dydt(7) = r(7)*y(5)*y(2)/(y(2) + s_IL4b) + G2*y(7)*y(4)/(y(4) + s_IL2b) - (Mu_Bdeath + Mu_Bdiff)*y(7) ; % EQUATION (6)  &  EQUATION (10)
...
for i = N:L
    ...
    dydt(5) =  Rate_prod*y(7) + Rate_prod*y(6) + Gs*y(5)*y(4)/(y(4) + s_IL4b)- Mu_death*y(5); % EQUATION (8)
    dydt(6) = r(6)*AntiG(i) - AntiG_die*y(6); % EQUATION (9)
